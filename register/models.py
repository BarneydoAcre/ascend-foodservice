...
class Partner(models.Model):
    ...
    cep = models.CharField(max_length=20, blank=True, null=True, default="")
    street = models.CharField(max_length=50, blank=True, null=True, default="")
    district = models.CharField(max_length=50, blank=True, null=True, default="")
    city = models.ForeignKey(default.models.City, blank=True, null=True, on_delete=models.PROTECT, default="1")
    num = models.CharField(max_length=20, blank=True, null=True, default="")
